...
from deepcode_vsa.integrations.registry import ToolRegistry, get_registry
...
class MockTool(APITool):
    ...
    def operations(self) -> list[Operation]:
        return [
            ...
            Operation(name="write_data", description="Write data", method="POST", requires_confirmation=True),
        ]
